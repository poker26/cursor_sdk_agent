...
- Только ответ на вопрос, без процесса и без «если нужен другой диапазон».
- Минимум слов: пересечения — да/нет + где; не расписывать все дни без запроса.
- Без «по вашему календарю», без ### и таблиц для простых ответов.
